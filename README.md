...
# data_for_rolling_slope.parquet
gdown --fuzzy 'https://drive.google.com/file/d/13WE55RHEE70Tw9hNfjmXFQTSYITUru9I/view?usp=drive_link'

# rolling_slope_v1.npy
gdown --fuzzy 'https://drive.google.com/file/d/1xfLKX4AOvd5CUUsNhlhMqNhXtEMBV1I1/view?usp=drive_link'
```
...
```bash
python localTest.py \
  --entry_point ops_ts_rolling_slope \
  --input_path ./testcase/data_for_rolling_slope.parquet \
  --ref_ans_path ./testcase/rolling_slope_v1.npy \
  --window 20
```
